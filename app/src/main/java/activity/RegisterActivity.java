...
public class RegisterActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                if (!name.isEmpty() && !email.isEmpty() && !password.isEmpty() && !nationality.isEmpty() && !age.isEmpty() && !phoneNo.isEmpty()) {
                    registerUser(name, email, password, nationality, age, phoneNo);
                } else {
    ...
    private void registerUser(final String name, final String email,
                              final String password, final String nationality, final String age, final String phoneNo) {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        Log.d(TAG, age + " hello");
//                        db.addUser(name, email, uid, nationality, age, phoneNo, created_at);
